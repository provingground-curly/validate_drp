...
from checkAstrometry import getCcdKeyName, isExtended, plotAstrometry, checkAstrometry
...
def loadAndMatchData(repo, visitDataIds, refDataIds,
    ...
    Return a pipeBase.Struct with mag, dist, delta_mag, and number of matches.
    """
    ...
    allDataIds = refDataIds 
    for v_row in visitDataIds:
        allDataIds.extend(v_row)

    print(repr(refDataIds))
    print(repr(visitDataIds))
    print(repr(allDataIds))
